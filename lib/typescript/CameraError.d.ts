...
export declare type SessionError = 'session/camera-not-ready' | 'session/audio-session-setup-failed' | 'session/audio-in-use-by-other-app' | 'audio-session-failed-to-activate';
export declare type CaptureError = 'capture/invalid-photo-format' | 'capture/encoder-error' | 'capture/muxer-error' | 'capture/recording-in-progress' | 'capture/no-recording-in-progress' | 'capture/file-io-error' | 'capture/create-temp-file-error' | 'capture/create-recorder-error' | 'capture/invalid-photo-codec' | 'capture/not-bound-error' | 'capture/capture-type-not-supported' | 'capture/video-not-enabled' | 'capture/photo-not-enabled' | 'capture/aborted' | 'capture/unknown';
